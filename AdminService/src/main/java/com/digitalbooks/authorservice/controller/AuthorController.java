...
public class AuthorController {
   ...
   {
	   return bookServiceClient.getAllEmployees();
   }
   ...
   @PostMapping("/employees") 
	 public Employee crateEmployee(@RequestBody Employee employee) {
	   System.out.println(employee);
		 return bookServiceClient.createEmployee(employee);
   ...
   {
	   return bookServiceClient.getEmployeeById(id);
   }
   ...
   {
	   return bookServiceClient.updateEmployee(id,employee);
   }
   ...
   {
	    return bookServiceClient.deleteEmployee(id);
   }
